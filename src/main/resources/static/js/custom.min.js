...
function init_sidebar() {
    function t() {
        ...
        var e = $BODY.outerHeight(), a = $BODY.hasClass("footer_fixed") ? -10 : $FOOTER.height(),
            t = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(), o = e < t ? t : e;
...
function init_starrr() {
    "undefined" != typeof starrr && (console.log("init_starrr"), $(".stars").starrr(), $(".stars-existing").starrr({rating: 4}), $(".stars").on("starrr:change", function (e, a) {
        $(".stars-count").html(a)
...
function init_skycons() {
    if ("undefined" != typeof Skycons) {
        ...
        var e, a = new Skycons({color: "#73879C"}),
...
function init_wysiwyg() {
    ...
    void 0 !== $.fn.wysiwyg && (console.log("init_wysiwyg"), $(".editor-wrapper").each(function () {
        var e = $(this).attr("id");
        $(this).wysiwyg({toolbarSelector: '[data-target="#' + e + '"]', fileUploadError: a})
...
function init_cropper() {
    if (void 0 !== $.fn.cropper) {
        ...
        var i = $("#image"), n = $("#download"), a = $("#dataX"), t = $("#dataY"), o = $("#dataHeight"),
            r = $("#dataWidth"), l = $("#dataRotate"), s = $("#dataScaleX"), c = $("#dataScaleY"), d = {
        ...
        $('[data-toggle="tooltip"]').tooltip(), i.on({
            ...
            var e, a, t = $(this), o = t.attr("name"), n = t.prop("type");
        ...
        var u, m = $("#inputImage"), p = window.URL || window.webkitURL;
        p ? m.change(function () {
            var e, a = this.files;
...
function init_knob() {
    if (void 0 !== $.fn.knob) {
        ...
        var e, a = 0, t = 0, o = 0, n = $("div.idir"), i = $("div.ival");
        $("input.infinite").knob({
...
function init_daterangepicker_single_call() {
    ...
    }), $("#single_cal2").daterangepicker({singleDatePicker: !0, singleClasses: "picker_2"}, function (e, a, t) {
        console.log(e.toISOString(), a.toISOString(), t)
    }), $("#single_cal3").daterangepicker({singleDatePicker: !0, singleClasses: "picker_3"}, function (e, a, t) {
        console.log(e.toISOString(), a.toISOString(), t)
    }), $("#single_cal4").daterangepicker({singleDatePicker: !0, singleClasses: "picker_4"}, function (e, a, t) {
        console.log(e.toISOString(), a.toISOString(), t)
    }))
}
...
function init_SmartWizard() {
    void 0 !== $.fn.smartWizard && (console.log("init_SmartWizard"), $("#wizard").smartWizard(), $("#wizard_verticle").smartWizard({transitionEffect: "slide"}), $(".buttonNext").addClass("btn btn-success"), $(".buttonPrevious").addClass("btn btn-primary"), $(".buttonFinish").addClass("btn btn-default"))
}
    ...
    if (console.log("run_customtabs"), "undefined" != typeof CustomTabs) {
        ...
        TabbedNotification = function (e) {
            ...
            $(".tabbed_notifications > div").hide(), $(".tabbed_notifications > div:first-of-type").show(), $("#custom_notifications").removeClass("dsp_none"), $(".notifications a").click(function (e) {
                e.preventDefault();
                var a = $(this), t = "#" + a.parents(".notifications").data("tabbed_notifications"),
                    o = a.closest("li").siblings().children("a"), n = a.attr("href");
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        if (console.log("init_charts"), Chart.defaults.global.legend = {enabled: !1}, $("#canvas_line").length) new Chart(document.getElementById("canvas_line"), {
            type: "line",
            data: {
        ...
        if ($("#canvasDoughnut").length) {
            ...
            new Chart(e, {type: "doughnut", tooltipFillColor: "rgba(51, 51, 51, 0.55)", data: a})
        }
        ...
        }, new Chart(e, {data: a, type: "polarArea", options: {scale: {ticks: {beginAtZero: !0}}}})
    }
}
...
function init_calendar() {
    if (void 0 !== $.fn.fullCalendar) {
        ...
        var o, e = new Date, a = e.getDate(), t = e.getMonth(), n = e.getFullYear(), i = $("#calendar").fullCalendar({
            ...
            editable: !0,
            events: [{title: "All Day Event", start: new Date(n, t, 1)}, {
                title: "Long Event",
...
function init_DataTables() {
    if (console.log("run_datatables"), void 0 !== $.fn.DataTable) {
        ...
        e.dataTable({order: [[1, "asc"]], columnDefs: [{orderable: !1, targets: [0]}]}), e.on("draw.dt", function () {
    ...
    if ("undefined" != typeof echarts) {
        ...
        if ($("#echart_gauge").length) echarts.init(document.getElementById("echart_gauge"), e).setOption({
            ...
            series: [{
                ...
                axisLine: {
                    show: !0,
                    lineStyle: {color: [[.2, "lightgreen"], [.4, "orange"], [.8, "skyblue"], [1, "#ff4500"]], width: 30}
                },
        ...
        if ($("#echart_bar_horizontal").length) echarts.init(document.getElementById("echart_bar_horizontal"), e).setOption({
            ...
            series: [{name: "2015", type: "bar", data: [18203, 23489, 29034, 104970, 131744, 630230]}, {
                name: "2016",
                type: "bar",
        ...
        if ($("#echart_pie2").length) echarts.init(document.getElementById("echart_pie2"), e).setOption({
            ...
            series: [{
                ...
                max: 40,
                sort: "ascending",
                data: [{value: 10, name: "rose1"}, {value: 5, name: "rose2"}, {value: 15, name: "rose3"}, {
                    value: 25,
                    name: "rose4"
        ...
        if ($("#echart_donut").length) echarts.init(document.getElementById("echart_donut"), e).setOption({
            ...
            series: [{
                ...
                itemStyle: {
                    ...
                    emphasis: {label: {show: !0, position: "center", textStyle: {fontSize: "14", fontWeight: "normal"}}}
                },
        ...
        if ($("#echart_pie").length) {
            ...
            var a = {normal: {label: {show: !1}, labelLine: {show: !1}}}, t = {
        ...
        if ($("#echart_mini_pie").length) echarts.init(document.getElementById("echart_mini_pie"), e).setOption({
            ...
            series: [{
                ...
                radius: [105, 130],
                itemStyle: a,
                data: [{value: 68, name: "68%Something #1"}, {value: 32, name: "invisible", itemStyle: t}]
            }, {
                name: "2",
                type: "pie",
                clockWise: !1,
                radius: [80, 105],
                itemStyle: a,
                data: [{value: 29, name: "29%Something #2"}, {value: 71, name: "invisible", itemStyle: t}]
            }, {
                name: "3",
                type: "pie",
                clockWise: !1,
                radius: [25, 80],
                itemStyle: a,
                data: [{value: 3, name: "3%Something #3"}, {value: 97, name: "invisible", itemStyle: t}]
            }]
        });
        if ($("#echart_world_map").length) echarts.init(document.getElementById("echart_world_map"), e).setOption({
            ...
            series: [{
                ...
                data: [{name: "Afghanistan", value: 28397.812}, {name: "Angola", value: 19549.124}, {
                    name: "Albania",
                    value: 3150.143
                    ...
                    value: 268.065
                }, {name: "Australia", value: 22404.488}, {name: "Austria", value: 8401.924}, {
                    name: "Azerbaijan",
                    value: 9094.718
                }, {name: "Burundi", value: 9232.753}, {name: "Belgium", value: 10941.288}, {
                    name: "Benin",
                    value: 9509.798
                }, {name: "Burkina Faso", value: 15540.284}, {name: "Bangladesh", value: 151125.475}, {
                    name: "Bulgaria",
                    value: 7389.175
                    ...
                    name: "Denmark",
                    value: 5550.959
                }, {name: "Dominican Republic", value: 10016.797}, {name: "Algeria", value: 37062.82}, {
                    name: "Ecuador",
                    value: 15001.072
                }, {name: "Egypt", value: 78075.705}, {name: "Eritrea", value: 5741.159}, {
                    name: "Spain",
                    value: 46182.038
                }, {name: "Estonia", value: 1298.533}, {name: "Ethiopia", value: 87095.281}, {
                    name: "Finland",
                    value: 5367.693
                }, {name: "Fiji", value: 860.559}, {name: "Falkland Islands", value: 49.581}, {
                    name: "France",
                    value: 63230.866
                }, {name: "Gabon", value: 1556.222}, {name: "United Kingdom", value: 62066.35}, {
                    name: "Georgia",
                    value: 4388.674
                }, {name: "Ghana", value: 24262.901}, {name: "Guinea", value: 10876.033}, {
                    name: "Gambia",
                    value: 1680.64
                }, {name: "Guinea Bissau", value: 10876.033}, {
                    name: "Equatorial Guinea",
                    value: 696.167
                }, {name: "Greece", value: 11109.999}, {name: "Greenland", value: 56.546}, {
                    name: "Guatemala",
                    value: 14341.576
                    ...
                    name: "Western Sahara",
                    value: 514.648
                }, {name: "Saudi Arabia", value: 27258.387}, {name: "Sudan", value: 35652.002}, {
                    name: "South Sudan",
                    value: 9940.929
                }, {name: "Senegal", value: 12950.564}, {
                    name: "Solomon Islands",
                    value: 526.447
                }, {name: "Sierra Leone", value: 5751.976}, {name: "El Salvador", value: 6218.195}, {
                    name: "Somaliland",
                    value: 9636.173
                }, {name: "Somalia", value: 9636.173}, {name: "Republic of Serbia", value: 3573.024}, {
                    name: "Suriname",
                    value: 524.96
                    ...
                    name: "East Timor",
                    value: 10016.797
                }, {name: "Trinidad and Tobago", value: 1328.095}, {name: "Tunisia", value: 10631.83}, {
                    name: "Turkey",
                    value: 72137.546
